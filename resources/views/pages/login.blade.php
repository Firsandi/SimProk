...
@section('body-class', 'bg-gradient-to-br from-teal-500 via-teal-600 to-emerald-600 min-h-screen flex items-center justify-center')
...
<div class="relative z-10 w-full max-w-4xl px-4 py-6 sm:px-6 md:px-8">
    <div class="flex flex-col overflow-hidden bg-white shadow-2xl rounded-2xl lg:flex-row min-h-96">
        ...
        <div class="flex flex-col justify-center p-8 lg:w-1/2 sm:p-12 bg-gray-50">
            ...
            <div class="flex flex-col items-start justify-between gap-4 pt-5 mt-6 border-t border-gray-200 sm:flex-row sm:items-center">
                <a href="{{ route('password.request') }}" class="text-teal-600 hover:text-teal-700 font-semibold text-xs sm:text-sm transition-all duration-300 flex items-center gap-1.5 hover:gap-2">
