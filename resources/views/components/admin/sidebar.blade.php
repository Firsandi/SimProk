    ...
    <div>
        ...
        <nav class="p-4 space-y-2">
            ...
            <a href="{{ route('admin.timeline') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.timeline') ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
